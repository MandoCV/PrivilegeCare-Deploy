...
@estudios.get("/estudios/{id}", response_model=schemas.estudios.Estudios, tags=["Estudios"], dependencies=[Depends(Portador())])
...
@estudios.post("/estudios/", response_model=schemas.estudios.Estudios, tags=["Estudios"])
...
@estudios.put("/estudios/{id}", response_model=schemas.estudios.Estudios, tags=["Estudios"], dependencies=[Depends(Portador())])
...
@estudios.delete("/estudios/{id}", response_model=schemas.estudios.Estudios, tags=["Estudios"], dependencies=[Depends(Portador())])
