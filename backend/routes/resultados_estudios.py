...
@resultados_estudios.get("/resultado_estudios/{id}", response_model=schemas.resultados_estudios.ResultadosEstudios, tags=["ResultadosEstudios"], dependencies=[Depends(Portador())])
...
@resultados_estudios.post("/resultado_estudios/", response_model=schemas.resultados_estudios.ResultadosEstudios, tags=["ResultadosEstudios"])
...
@resultados_estudios.put("/resultado_estudios/{id}", response_model=schemas.resultados_estudios.ResultadosEstudios, tags=["ResultadosEstudios"], dependencies=[Depends(Portador())])
...
@resultados_estudios.delete("/resultado_estudios/{id}", response_model=schemas.resultados_estudios.ResultadosEstudios, tags=["ResultadosEstudios"], dependencies=[Depends(Portador())])
