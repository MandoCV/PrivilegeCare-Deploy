...
@resultados_estudios.get("/resultado_estudio/{id}", response_model=schemas.resultados_estudios.ResultadosEstudios, tags=["ResultadosEstudios"], dependencies=[Depends(Portador())])
...
@resultados_estudios.post("/resultado_estudio/", response_model=schemas.resultados_estudios.ResultadosEstudios, tags=["ResultadosEstudios"])
...
@resultados_estudios.put("/resultado_estudio/{id}", response_model=schemas.resultados_estudios.ResultadosEstudios, tags=["ResultadosEstudios"], dependencies=[Depends(Portador())])
...
@resultados_estudios.delete("/resultado_estudio/{id}", response_model=schemas.resultados_estudios.ResultadosEstudios, tags=["ResultadosEstudios"], dependencies=[Depends(Portador())])
