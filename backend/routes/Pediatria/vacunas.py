...
@vacuna.get("/vacunas/", response_model=List[schemas.Pediatria.vacunas.Vacuna], tags=['Pediatria'])
...
@vacuna.get("/vacunas/{id}/", response_model=List[schemas.Pediatria.vacunas.Vacuna], tags=['Pediatria'])
...
@vacuna.post("/vacunas/", response_model=schemas.Pediatria.vacunas.Vacuna, tags=["Pediatria"])
